//this is lesson 0 of 8608 learnign to program
//lesson 0 - hello world and the basic Timed robot skeleton
// build and upload to the robot, then watch the rio log and it should be printing out results. 
// you should look at the code and think and know when those codes are running and how often? once ,twice ,all the time?
...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    System.out.println("teleopPeriodic Running- MatchTime :" + DriverStation.getMatchTime());
  }
