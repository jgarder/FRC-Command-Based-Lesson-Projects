...
public class RobotContainer {
  ...
  @Logged (name = "Trigger A Button")
  Trigger joystickATrigger = joystick.a();
  ...
  private void configureBindings() {
    ...
    joystickATrigger.whileTrue(new cmd_SequenceOfCommands().repeatedly());
    ...
    joystick.a().onFalse(Commands.runOnce(()->{System.out.println("button A now false");}).withName("Button A on false command"));
    ...
    joystick.b().whileTrue( cmdFactory.sequenceOfPrints().withName("B ButtonSequence")); 
