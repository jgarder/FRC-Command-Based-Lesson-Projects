...
public class Arm implements AutoCloseable {
  ...
  private double PGain = Constants.kDefaultArmKp;
  ...
  public void reachSetpoint() {
    SmartDashboard.putNumber(className + " Setpoint", m_armSetpointDegrees);
    var pidOutput =
  ...
  public void stop() {
    SmartDashboard.putNumber(className + " Setpoint", 0.0);
    m_motor.set(0.0);
  }
